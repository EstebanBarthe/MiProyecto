<h1>Menu</h1>
    <div>
        <a class="waves-effect waves-light btn modal-trigger green darken-4" href="#modal1">
            <i class="material-icons left">add</i>Ingresar</a>
    </div>
        ...
        <table class="striped">
            <thead>
                <tr>
                    ...
                    <th style="width:200px">Botones</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                ...
                <tr class="teal darken-4">
                    <td colspan="6">
                        <ul class="pagination center">
                            ...
                            <li class="waves-effect"><a href="#!" class="black-text">2</a></li>
                            <li class="waves-effect"><a href="#!" class="black-text">3</a></li>
                            <li class="waves-effect"><a href="#!" class="black-text">4</a></li>
                            <li class="waves-effect"><a href="#!" class="black-text">5</a></li>
